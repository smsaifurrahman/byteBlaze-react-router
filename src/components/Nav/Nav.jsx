...
const Nav = () => {
  ...
  <div className="flex-none">
    ...
    ">
      <NavLink to= '/' className={({isActive})=> isActive ? 'text-primary font-bold text-xl': 'font-bold text-xl' }>Home
      </NavLink>
        <NavLink to= '/blogs'className={({isActive})=> isActive ? 'text-primary font-bold text-xl': 'font-bold text-xl' }>Blogs
        </NavLink>
        <NavLink to= '/bookmarks' className={({isActive})=> isActive ? 'text-primary font-bold text-xl': 'font-bold text-xl' }>BookMarks
        </NavLink>
